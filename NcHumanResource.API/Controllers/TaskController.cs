...
namespace NcHumanResource.Controllers
{
    ...
    public class TaskController : ControllerBase
    {
        ...
        [HttpPost("{employeeId}")]
        public async Task<IActionResult> Add(string employeeId, [FromBody] TaskItemDto dto)
        {
        ...
        [HttpPut("{employeeId}")]
        public async Task<IActionResult> Update(string employeeId, [FromBody] TaskItemDto dto)
        {
